...
require 'marty/aws/cognito_view'
require 'marty/aws/api_view'
require 'marty/aws/apigateway_api_view'
require 'marty/aws/apigateway_key_view'
require 'marty/aws/apigateway_authorizer_view'
require 'marty/aws/apigateway_api_stage_view'
require 'marty/aws/apigateway_api_usage_plan_view'
require 'marty/aws/apigateway_api_usage_plan_key_view'
require 'marty/aws/apigateway_api_authorizer_stage_view'
require 'marty/aws/api_user_view'
require 'marty/aws/api_key_view'
