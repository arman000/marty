class CreateCategories < ActiveRecord::Migration[4.2]
  def up
    ...
    McflyAppendOnlyMigration[4.2].new.create_table 'gemini_bud_categories' do |t|
      t.string :name
    end
    McflyAppendOnlyMigration[4.2].new.add_sql 'gemini_bud_categories', false

    McflyMigration[4.2].new.create_table 'gemini_fannie_bups' do |t|
      t.integer  "entity_id"
    ...
    McflyMigration[4.2].new.add_sql 'gemini_fannie_bups', false
  end
